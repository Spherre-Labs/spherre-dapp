...
class SmartLockService:
    ...
    @classmethod
    def update_lock_status(cls, lock_id: int, new_status: LockStatus) -> SmartLock:
        """
    ...
    def list_all_smart_locks(
        cls, status_filter: Optional[LockStatus] = None
    ) -> List[SmartLock]:
        """
    ...
    @classmethod
    def get_smart_lock_by_lock_id(cls, lock_id: int) -> Optional[SmartLock]:
        """

...
const ConfirmationFooter = () => {
  return (
    <div className=" w-full max-w-[628px] px-[26px] py-[28px] bg-[#1C1D1F]  md:h-[283px] rounded-[10px] flex flex-col items-start justify-center gap-7  overflow-hidden ">
      <div className=" w-full flex items-center justify-between gap-5  ">
        ...
        <div className=" h-[90px] flex flex-col justify-between items-start  " >
            ...
            <small className="text-[#8E9BAE] font-semibold text-xs md:text-base " >Members</small>
        ...
        <div className=" h-[90px] flex flex-col justify-between items-start  " >
            ...
            <small className="text-[#8E9BAE] font-semibold text-xs md:text-base  " >Threshold</small>
      ...
      <div className=" w-full flex items-center justify-between gap-5  ">
        <button className="basis-1/2 bg-[#272729] rounded-[7px] max-w-[281px] h-[50px] flex items-center justify-center text-white text-center text-base font-medium "> Back </button>

        <button className="basis-1/2 bg-white rounded-[7px] max-w-[281px] h-[50px] flex items-center justify-center text-[#101213] text-center text-base font-medium">Confirm</button>
      </div>
    </div>
  )
}

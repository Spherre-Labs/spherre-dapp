    ...
    <div className="w-full bg-theme-bg-secondary border border-theme-border overflow-hidden transition-colors duration-300">
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-2 sm:gap-4 items-center flex-grow min-w-0">
          ...
          <div className="flex items-center justify-end space-x-2 sm:space-x-4">
            ...
            <svg
              className={`w-4 h-4 sm:w-5 sm:h-5 text-theme-secondary transform transition-all duration-300 ${
      ...
      >
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="lg:w-1/2 p-3 sm:p-4 border-r border-theme-border flex flex-col">
            ...
            <div className="flex-grow">
              <div className="flex mb-2 mt-2">
                <div className="flex">
                  <div className="flex flex-col items-center mr-3 sm:mr-4">
                    <div className="w-2 h-2 bg-theme rounded-full flex items-center justify-center mb-1">
                      <svg
                    ...
                    <div className="h-full w-0.5 bg-theme-border"></div>
                  </div>
                  <div>
              ...
              <div className="flex mb-2 mt-2">
                <div className="flex">
                  <div className="flex flex-col items-center mr-3 sm:mr-4">
                    <div
                      className={`w-2 h-2 bg-theme ${transaction.status} rounded-full flex items-center justify-center mb-1`}
                    >
                      {transaction.status === 'Pending'}
                    </div>
                    <div className="h-full w-0.5 bg-theme-border"></div>
              ...
              <div className="flex mb-2 mt-2">
                <div className="flex">
                  <div className="flex flex-col items-center mr-3 sm:mr-4">
                    <div
                      className={`w-2 h-2 border border-theme-border ${transaction.status === 'Executed' ? 'bg-theme' : ''} rounded-full flex items-center justify-center mb-1`}
                    >
                      {transaction.status === 'Executed' ? (
                        <svg
                          className="w-4 h-4 sm:w-5 sm:h-5 text-theme"
            ...
            <div className="mt-auto pt-3 sm:pt-4">
              {transaction.status === 'Pending' && (
                <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                  <button className="bg-primary hover:opacity-90 text-white px-4 sm:px-6 py-2 rounded-md transition-all duration-200 text-sm sm:text-base w-full sm:w-1/2">
                    Approve
                  </button>
                  <button className="bg-theme-bg-tertiary border border-theme-border hover:bg-theme-bg-secondary text-theme px-4 sm:px-6 py-2 rounded-md transition-colors duration-200 text-sm sm:text-base w-full sm:w-1/2">
                    Reject
                  </button>
                </div>
              )}
              {(transaction.status === 'Executed' ||
                ...
                <button className="bg-primary hover:opacity-90 text-white px-4 sm:px-6 py-2 rounded-md transition-all duration-200 text-sm sm:text-base w-full">
                  Download CSV
                </button>
              )}
            </div>
          ...
          <div className="lg:w-1/2 p-3 sm:p-4 flex flex-col">
            ...
            <Link href={`/dapp/transactions/${transaction.id}`}>
              <button className="mt-3 sm:mt-4 w-full bg-theme-bg-tertiary border border-theme-border text-theme py-2 rounded-lg hover:bg-theme-bg-secondary transition-colors duration-200 text-sm sm:text-base">

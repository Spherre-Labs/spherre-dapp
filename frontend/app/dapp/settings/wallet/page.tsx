  ...
  return (
    <div className="text-white p-6">
      <div className="mx-auto">
        ...
        <div className="mt-8">
          <h3 className="text-xl font-medium text-gray-400 mb-6">
            More Details
          </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-[#1C1D1F] rounded-xl p-6">
              ...
              <button
                onClick={openModal}
                className="w-full bg-[#272729] hover:bg-black/40 text-white py-3 rounded-lg font-medium transition-all flex items-center justify-center space-x-2"
              >

...
export default function WithdrawalPage() {
  ...
  return (
    <div className=" xl:h-full sm:h-auto h-full  w-full font-sans bg-black text-white p-4 sm:p-6 flex flex-col items-center sm:justify-center mx-auto relative">
      {/* Go Back Button */}
      <button

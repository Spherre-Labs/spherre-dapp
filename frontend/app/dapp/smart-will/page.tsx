  ...
  return (
    <div className="p-4 font-['Nunito_Sans']">
      <h1 className="text-2xl font-bold flex items-center gap-2.5">
        Smart Will <Info size={20} color="#8E9BAE" />{' '}
      </h1>
      ...
      <section className="w-full flex items-start flex-col md:flex-row justify-between gap-5 py-5">
        ...
        <div className="w-full flex-1 bg-[#1C1D1F] rounded-[10px] p-4 h-fit flex flex-col items-start gap-10 ">
            ...
            <div className="flex-1 flex flex-col items-start gap-2.5 justify-between ">
              ...
              <div className="bg-[#101213] w-full flex items-center justify-between gap-2 py-2.5 px-4 rounded-[10px]  ">
                <input
                  ...
                  type="text"
                  id="address"
                  className=" flex-1 text-[#8E9BAE] font-normal text-base bg-transparent outline-none border-none max-w-sm "
                  readOnly
                />
                <button
                  onClick={() => handleCopy(address!, 'primary')}
                  className="bg-[#29292A] p-1 rounded-[5px] "
                >
                  {' '}
                  {isCopiedAddress ? <Check /> : <Copy />}{' '}
                </button>
              </div>
            </div>

            <div className="  flex flex-col items-start gap-2.5 justify-between w-full max-w-[158px] ">
              <h6 className=" text-[#8E9BAE] font-normal text-sm flex items-center gap-2.5 ">
                Main Wallet <Info size={20} color="#8E9BAE" />{' '}
              </h6>
          ...
          <div className="w-full flex items-center justify-between gap-5 flex-wrap">
            ...
            <div className="  flex flex-col items-start gap-2.5 justify-between w-full max-w-[158px] ">
              <h6 className=" text-[#8E9BAE] font-normal text-sm flex items-center gap-2.5 ">
                Will Wallet <Info size={20} color="#8E9BAE" />{' '}
              </h6>
              <div className="bg-[#101213] py-2.5 px-4 rounded-[10px] w-full text-[#8E9BAE] font-normal text-base ">
                <select
                  value={walletType}
                  onChange={(e) => setWalletType(e.target.value)}
                  className="bg-transparent !p-0  !text-[#8E9BAE] !font-normal !text-base !w-full outline-0 border-0 cursor-pointer "
                >
          ...
          <div className="w-full flex flex-col gap-4">
            <h3 className="text-[#8E9BAE] text-sm font-normal ">
            ...
            <div className="w-fit flex flex-wrap items-center gap-10 ">
              <div className="w-full flex-1 flex items-center gap-1.5 md:gap-2.5">
                {['days', 'hours', 'minutes', 'seconds'].map((unit, i) => (
                  ...
                  >
                    <span className="font-bold text-lg md:text-2xl text-[#FFFFFF] ">
                      {timerValues[unit as keyof typeof timerValues]}{' '}
                    </span>
                    <span className=" text-xs md:text-sm font-normal text-[#8E9BAE] ">
              ...
              <Button
                ...
                variant="secondary"
                className=" bg-[#272729] !p-2.5  rounded-[10px] "
              >
                <TimerReset />
                Reset Countdown
              </Button>
